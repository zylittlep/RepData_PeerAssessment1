...
```{r plotting daily total steps and calculating the mean and median, echo=TRUE, fig.height=4, fig.width=5}
...
```{r replace na with interval average, echo=TRUE, fig.height=4, fig.width=5}
...
```{r comparing activity in weekdays and weekends, echo=TRUE, fig.height=4, fig.width=5}
